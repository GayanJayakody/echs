...
$sql = "SELECT name,description,img_link,estimated_cost,raised FROM projects WHERE project_id=14"; //reading things from the table
               ...
               echo' <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        ...
                        <div class="entry-content mt-5">
                            <p>'.$pdescription.'</p>
                            <a href="uploads/Bridge.pdf" >View the Report</a>
                        </div><!-- .entry-content -->
